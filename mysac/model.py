...
class SACAgent(torch.nn.Module, BaseAgent):
    def __init__(self,observation_space, action_space,
        ...
        **kwargs):
        ...
        self.weight_network = QNetwork(state_dim + action_dim, 1, **kwargs['weight_network'])
        ...
        self.weight_network = self.weight_network.to(util.device)
        ...
        self.weight_optimizer = get_optimizer(kwargs['weight_network']['optimizer_class'], self.weight_network, kwargs['weight_network']['learning_rate'])
    ...
    def update(self, data_batch):
        ...
        #compute q loss
        q1_loss = (curr_state_q1_value - target_q.detach()).pow(2).mean()
        q2_loss = (curr_state_q2_value - target_q.detach()).pow(2).mean()
        ...
        #compute weight loss
        weight_loss = 
        weight_loss_value = weight_loss.detach().cpu().numpy()
